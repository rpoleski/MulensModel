...
JCY - I am not certain this should be implemented as part of the Model
class or if there should be derivative classes: BinarySourceModel,
XallarapModel. See astropy.modeling package
...
two_source_model = Model(
    t_0_1=2457501.374, u_0_1=0.015, t_0_2=2457507.804, u_0_2=0.365, t_E=14.428, 
    source_flux_ratio={'I':1.853})
...
# Xallarap Model 
xallarap_model = Model(t_0=2457800, u_0=0.001, t_E=32., xsi=[0.1, 0.2], period=3.)
xallarap_model_2 = Model(
    t_0=2457800, u_0=0.001, t_E=32., xsi_N=0.1, xsi_E=0.2, period=3.)
...
two_source_motion = Model(
    t_0=2457800, u_0=0.3, t_E=32, s_source=0.2, q_source=0.5, alpha_source=0.1, 
    ds_dt_source = 1.0, dalpha_dt_source=0.7, flux_ratio={'I':0.1, 'V':0.15})
