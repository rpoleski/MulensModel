...
e = MulensModel.Event(datasets=data, model = model) # note that data is an instance of Ulens.Data but e.datasets is a list
...
for dataset in e.datasets:
    ...
    pl.plot(e.model.t_data[i], e.model.mag_data[i])
