'''
This example shows OGLE-2003-BLG-235/MOA-2003-BLG-53, the first microlensing
planet; Bond et al. 2004 (http://adsabs.harvard.edu/abs/2004ApJ...606L.155B). 
...
# Import data
data_dir = os.path.join(MODULE_PATH, 'data', 'OB03235')
...
my_event.plot_model(subtract_2450000=True, t_range=t_range, n_epochs=4000, 
    color='black')
