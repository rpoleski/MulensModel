"""
Basically the same as example_01, but edited for additional Version 3 behavior:
Lines 24 and 32. The original version should continue to work in Version 3.
...
pspl = mm.PSPLModel({'t_0': t_0, 'u_0': u_0, 't_E': t_E})  # Version 3 Edit
