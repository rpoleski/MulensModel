...
plot_kwargs = {
    ...
    1: {"fmt": 's', "color": "orange", "ms": 5, "label": "MM rectilinear numpy.sum", **common_kwargs},
    2: {"fmt": 'bs', "ms": 5, "label": "pyLIMA rectilinear", **common_kwargs},
    3: {"fmt": 'ro', "ms": 10, "label": "MM parallax", **common_kwargs},
    4: {"fmt": 'o', "color": "orange", "ms": 10, "label": "MM parallax numpy.sum", **common_kwargs},
