...
pyLIMA_parameters = model_1.compute_pyLIMA_parameters([t_0, u_0, t_E, pi_E_N, pi_E_E])
model = model_1.compute_the_microlensing_model(telescope_1, pyLIMA_parameters)  
mag = model_1.model_magnification(telescope_1, pyLIMA_parameters)
plt.plot(time-d_time, mag, 'b.', label='pyLIMA')

# This are the changes I have to make to make the things as close as possible:
u_0 = -u_0
pi_E_E = -pi_E_E

# MulensModel calculations and plot:
coords = SkyCoord(ra_deg, dec_deg, unit=u.deg)
params = {'t_0': t_0, 'u_0': u_0, 't_E': t_E, 'pi_E_N': pi_E_N, 'pi_E_E': pi_E_E}
