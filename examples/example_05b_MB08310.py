"""
Basically the same as example_05, but edited for additional Version 3 behavior:
Line 35. The original version should continue to work in Version 3.
...
t_E = 11.14
t_star = 0.05487
plens_model = mm.FSPLModel(
    {'t_0': t_0, 'u_0': u_0, 't_E': t_E, 't_star': t_star})  # Version 3 Edit
