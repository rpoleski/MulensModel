...
def ln_prob(theta, event, parameters_to_fit):
    ...
    if np.isnan(ln_like_): # In the cases that source fluxes are negative we
...
params['u_0'] = 0.37 # Change it to negative to find the other solution.
params['t_E'] = 100.
params['pi_E_N'] = 0.
params['pi_E_E'] = 0.
...
model_1 = Model({'t_0': 2453630.35507, 'u_0': 0.488817, 't_E': 93.611301,
        'pi_E_N': 0.2719, 'pi_E_E': 0.1025, 't_0_par': params['t_0_par']},
        coords=coords)
model_2 = Model({'t_0': 2453630.67778, 'u_0': -0.415677, 't_E': 110.120755,
