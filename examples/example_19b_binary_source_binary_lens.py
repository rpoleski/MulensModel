"""
Basically the same as example_19, but edited for additional Version 3 behavior:
Lines 30--32. The original version should continue to work in Version 3.
...
model = mm.BSBLModel(parameters)  # Version 3 Edit
model_1 = mm.FSBLModel(parameters_1)  # Version 3 Edit
model_2 = mm.FSBLModel(parameters_2)  # Version 3 Edit
