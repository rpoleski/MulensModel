"""
Basically the same as example_21, but edited for additional Version 3 behavior:
Lines 19--21. The original version should continue to work in Version 3.
...
shear_model = mm.model.PSBLShearModel(
    {**mass_sheet, **standard_parameters})  # Version 3 Edit
no_shear_model = mm.model.PSBLModel(standard_parameters)  # Version 3 Edit
