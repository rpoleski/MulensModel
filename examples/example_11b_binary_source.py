"""
Basically the same as example_11, but edited for additional Version 3 behavior:
Line 146. The original version should continue to work in Version 3.
...
params = {'t_0_1': 6101., 'u_0_1': 0.19, 't_0_2': 6140.123, 'u_0_2': 0.04,
          't_E': 20.}
my_model = mm.BSPLModel(params)  # Version 3 Edit
