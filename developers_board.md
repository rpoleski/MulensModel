...
* Documentation
  ...
  * files not yet well documented (starting from the shortest): 
    * trajectory.py 
...
* Function Improvements/Expansion
  ...
  * Event class:
    * [What?] single Event can have many instances of Model associated with it
