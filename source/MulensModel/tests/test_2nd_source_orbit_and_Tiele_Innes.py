...
# -*- coding: utf-8 -*-
"""
Testing of 2nd source orbit calculation using Tiele Innes elements and transformation to
...
def get_orbits_TI(kwargs):
    """
    Returns MulensModel orbit based on Tiele -Innes parametrization and trandsformation to standard parametrization
    """
