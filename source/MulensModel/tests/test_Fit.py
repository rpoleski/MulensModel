...
def test_update():
    ...
    err = flux * 0. + 1.e-3
    dataset_1 = MulensData(data_list=[time, flux, err], phot_fmt='flux')
    fit_1 = Fit(data=[dataset_1], magnification=magnification)
    fit_1.fit_fluxes()
    ...
    err = flux * 0. + 1.e-3
    dataset_2 = MulensData(data_list=[time, flux, err], phot_fmt='flux')
    fit_2 = Fit(data=[dataset_2], magnification=magnification)
    fit_2.fit_fluxes()
