...
class Trajectory(object):
    ...
    def get_xy(self):
        ...
        is_mass_sheet_with_shear = self.parameters.is_external_mass_sheet_with_shear
        n_lenses = self.parameters.n_lenses
        if n_lenses == 1 and not is_mass_sheet_with_shear:
            vector_x = vector_tau
            vector_y = vector_u
        elif n_lenses == 2 or (n_lenses == 1 and is_mass_sheet_with_shear):
