...
$convergence_K$ & {\tt convergence_K} & & External mass sheet convergence. \\
$shear_G$ & {\tt shear_G} & & External mass sheet shear; complex valued to represent both the magnitude and angle relative to the binary axis. \\
