...
$t_{0,{\rm par}}$ & {\tt t\_0\_par} & & The reference time for parameters in parallax models. \\
...
$t_{0,{\rm kep}}$ & {\tt t\_0\_kep} & & The reference time for lens orbital motion calculations. \\
\end{tabular}
%\caption{\label{}}
\end{table*}
