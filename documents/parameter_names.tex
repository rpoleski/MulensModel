...
$s_{z}$ & {\tt s\_z} & & Position along the line of sight as a fraction of the Einstein ring radius. Positive axis points to the observer. $^d$\\
$ds_{z}/dt$ & {\tt ds\_z\_dt} & yr$^{-1}$ & The rate of change of $s_{z}$. $^d$\\
...
$^d$ -- To include keplerian motion of the lenses on a circular orbit either $s_{z}$ or $ds_{z}/dt$ needs to be added to the parameter space.
%\label{}
}
\end{longtable}
\end{landscape}
