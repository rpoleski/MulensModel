...
$\chi_a$ & \texttt{xi\_semimajor\_axis} & XXX & xallarap semimajor axis \\
$\chi_i$ & \texttt{xi\_inclination} & deg & xallarap inclination \\
$\chi_\Omega$ & \texttt{xi\_Omega\_node} & deg & xallarap Omega\_node \\
$\chi_{XXX}$ & \texttt{xi\_argument\_of\_latitude\_reference} & deg & xallarap argument of latitude reference \\
