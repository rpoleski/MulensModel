...
$convergence_K$ & {\tt convergence_K} & & The external convergence in the lensing system. \\
$shear_G$ & {\tt shear_G} & & The external shear in the lensing system; complex valued to represent both the magnitude and angle relative to the binary axis. \\
